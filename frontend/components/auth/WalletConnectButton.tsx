...
export default function WalletConnectButton({
    ...
    const handleWalletConnect = async () => {
        ...
        try {
            ...
            // 3. Sign Challenge
            toast.loading('Please sign the transaction in your wallet...', { id: 'wallet-sign' });
            let signature = '';
            try {
            ...
            if (!errorMessage.toLowerCase().includes('cancelled') && !errorMessage.toLowerCase().includes('reject')) {
    ...
    return (
        ...
        >
            ...
            <span className="relative z-10">{isLoading ? 'Connecting...' : buttonText}</span>
        </button>
    );
}
